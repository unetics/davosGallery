...
function easy_image_gallery_admin_init() {
	...
	// settings
	add_settings_field( 'header', '<h3 class="title">Easy Image Gallery</h3>', 'easy_image_gallery_header_callback', 'media', 'default' );
	add_settings_field( 'lightbox','Lightbox', 'easy_image_gallery_lightbox_callback', 'media', 'default' );
	add_settings_field( 'post-types', 'Post Types', 'easy_image_gallery_post_types_callback', 'media', 'default' );
}
