...
//                             e.stopPropagation();
        ...
        var setUp = {
            ...
            touch: function () {
                var xStart, xEnd;
                var $this = this;
                $('.lg-slide.current').bind('mousedown', function (e) {
//                     e.stopPropagation();
                    e.preventDefault();
                    xStart = e.pageX;
                });
                $('.lg-slide.current').bind('mouseup', function (e) {
//                     e.stopPropagation();
                    e.preventDefault();
                    xEnd = e.pageX;
                    if (xEnd - xStart > 20) {
            ...
            buildThumbnail: function () {
                if (settings.thumbnail === true && $children.length > 1) {
                    ...
                    thumbInfo.prepend('<span class="ib count">Gallery</span>');
                    if (settings.showThumbByDefault) {
                        $gallery.addClass('open');
                    }
                }
            ...
            Order: function () {
                ...
                $gallery.find('.cl-order').bind('click touchend', function () {
                    $gallery.addClass('orderOpen');
                });
                $gallery.find('.orderClose').bind('click touchend', function (e) {
                        $gallery.removeClass('orderOpen');
                        e.preventDefault();
                });
            },
            autoStart: function () {
